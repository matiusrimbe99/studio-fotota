                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input id="packet_name" class="form-control" value="{{ $studio->studio_name }}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="description">Deskripsi Paket</label>
                                <input id="description" class="form-control" value="{{ $studio->description }}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="price">Harga Paket</label>
                                <input id="price" class="form-control" value="@currency($studio->price)" readonly>
                            </div>
                        </div>
                        <!-- /.card-body -->
