                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $user->admin->name }}" id="name" name="name"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $user->admin->address }}" id="address" name="address"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $user->admin->nomor_hp }}" id="nomor_hp"
